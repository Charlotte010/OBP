        ...
        for care in list_care_queue2:
            ...
            for medical in list_medical_queue2:
                ...
                for i in range(0,amount_arrive):
                    if medical == 'Hospital':
                        e1 = make_elderly_class(outflow_table, arrival_rate_table, service_rate_index, care, medical, 0)
                        
                        waiting_list_3.append(e1)
                    else:
                        e1 = make_elderly_class(outflow_table, arrival_rate_table, service_rate_index, care, medical, 1)
